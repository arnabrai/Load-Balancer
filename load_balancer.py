...
def upload_server():
    ...
    if new_server_url:
        ...
        new_server.start_health_check(health_check_interval)  # Start health check thread for new server
